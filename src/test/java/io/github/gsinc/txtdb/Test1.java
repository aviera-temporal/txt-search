...
public class Test1 {
    ...
    public void test_do_processing() throws IOException {
        ...
        new FileProcessor(FilterField.CITY, "BARCELONA").processOutput(bufferedReader, new OutputHandler<>(System.out));
    }
    @Test
    public void test_do_processing_2() throws IOException {
        ...
        InputStreamReader irs = new InputStreamReader(resourceAsStream);
        BufferedReader bufferedReader = new BufferedReader(irs);
        new FileProcessor(FilterField.ID, "25384390A").processOutput(bufferedReader, new OutputHandler<>(System.out));
    }
